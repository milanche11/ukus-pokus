...
class SearchModel extends Model{
	...
	public function Index(){
		...
		$resultArray = array($ingredients, $categoriesAll, $recipesPop, $recipesLatest, $photosLatest, $photosPop);
