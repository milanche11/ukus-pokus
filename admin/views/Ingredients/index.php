	...
	<header class="box-typical-header">
		<div class="tbl-row">
			<div class="tbl-cell tbl-cell-title text-center">
				<h3><i class="font-icon color-yellow fas fa-lemon fa-lg"></i>&nbsp; &nbsp; &nbsp; Namirnice &nbsp; &nbsp; &nbsp; <span class="label label-pill" id="numberIngredients"></span></h3>
			</div>
		</div>
	</header>
	<header class="box-typical-header">
...
<section class="box-typical">
	...
	<div class="box-typical-body" id="ingredients-index">

	</div><!--.box-typical-body-->
</section><!--.box-typical-->

<section id="paginationIngredients">
  <nav aria-label="pagination">
          <ul class="pagination justify-content-center"  id="paginationIngredients">
...
$ingredients = $viewmodel[0];  //spisak svih jedinica mere
